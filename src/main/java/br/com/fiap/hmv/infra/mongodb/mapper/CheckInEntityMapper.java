    ...
    public static CheckIn toCheckIn(CheckInEntity checkInEntity) {
        return CheckIn.builder()
                ...
                .patient(Patient.builder()
                        .patientId(checkInEntity.getPatientId())
                        .patientTaxId(checkInEntity.getPatientTaxId())
                        .fullName(checkInEntity.getPatientFullName())
                        .birthDate(checkInEntity.getPatientBirthDate())
                        .genre(checkInEntity.getPatientGenre()).build())
                .attendant(nonNull(checkInEntity.getAttendantId()) ?
                        User.builder()
                                .userId(checkInEntity.getAttendantId())
                                .fullName(checkInEntity.getAttendantFullName())
                                .build()
                        : null
                )
                .serviceDesk(checkInEntity.getServiceDesk())
